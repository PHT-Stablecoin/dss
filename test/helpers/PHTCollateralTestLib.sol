        ...
        return
            h.addCollateral(
                ...
                PHTCollateralHelper.FeedParams({
                    ...
                    decimals: 0,
                    initialPrice: int(0),
                    numeratorFeed: address(PriceFeedFactory(res.priceFeedFactory).create(8, int(1e8), "DAI/USD")),
                    invertNumerator: false,
                    denominatorFeed: address(PriceFeedFactory(res.priceFeedFactory).create(8, int(0.0172e8), "PHP/USD")),
                    invertDenominator: false,
