...
import "./helpers/DssDeploy.fork.sol";
...
contract DssDeployTestBase is Test, ProxyActions {
    ...
    address CHAINLINK_MAINNET_USDT_USD = 0x3E7d1eAB13ad0104d2750B8863b489D65364e32D;
    address CHAINLINK_MAINNET_ETH_USD = 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419;
    // address CHAINLINK_MAINNET_PHP_USD = 0x0000000000000000000000000000000000000000;
    ...
    // Pips
    DSToken gov;
    AggregatorV3Interface pipETH;
    AggregatorV3Interface pipCOL;
    AggregatorV3Interface pipCOL2;
    AggregatorV3Interface pipUSDT;
    AggregatorV3Interface pipPHS;
    AggregatorV3Interface pipXINF;
